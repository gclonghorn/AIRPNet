CUDA_VISIBLE_DEVICES=0 python train_LSR.py \
   ...
   --nrate 0 --brate 0 --lrate 1 --degrade_type 3  \
   --hide_checkpoint /path/to/checkpoints/_checkpoint_best_loss.pth.tar \
   --checkpoint /path/to/checkpoints/_checkpoint_best_loss.pth.tar
